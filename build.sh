...
cp target/wasm32-unknown-unknown/release/sputnik_nft_staking.wasm ./sputnik-nft-staking/res/
...
cp target/wasm32-unknown-unknown/release/nft-staking-factory.wasm ./nft-staking-factory/res/
